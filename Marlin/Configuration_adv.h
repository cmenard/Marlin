 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        45 // Seconds - If bed is close to ABS temp (110) reheating the bed would cause error
...
// Disabled after tuning because of extruder stepper getting abused during printing
...
//#define FWRETRACT
  ...
  #define RETRACT_ZRAISE .30              // (mm) Default retract Z-raise
...
#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_POWERUP_DELAY   500   // (ms) Delay to allow the spindle/laser to come up to speed/power
  #define SPINDLE_LASER_POWERDOWN_DELAY 500   // (ms) Delay to allow the spindle to stop
